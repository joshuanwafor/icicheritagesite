...
export default function Footer() {
  ...
  const contactInfo = [
    {
      ...
      text: '+234 916 075 7433',
      href: 'tel:+2349160757433'
    },
    {
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const socialMedia = [
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@icicheritage',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/icicheritage',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
